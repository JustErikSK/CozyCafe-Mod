...
public class ModItemsCafe {
    ...
    public static final Item APPLE_JUICE = registerItem("apple_juice", new DrinkItem(new FabricItemSettings()));
    ...
    public static final Item CHOCOLATE_MILK = registerItem("chocolate_milk", new DrinkItem(new FabricItemSettings()));
    ...
    public static final Item GLOWBERRY_JUICE = registerItem("glowberry_juice", new DrinkItem(new FabricItemSettings()));
    public static final Item GLOWBERRY_PIE = registerItem("glowberry_pie", new Item(new FabricItemSettings()));
    public static final Item MELONADE = registerItem("melonade", new DrinkItem(new FabricItemSettings()));
    ...
    public static final Item SWEETBERRY_JUICE = registerItem("sweetberry_juice", new DrinkItem(new FabricItemSettings()));
